        ...
        <div>
          <div class="inline-flex h-16 w-16 items-center justify-center">
            <span class="block h-10 w-10 rounded-lg bg-gray-200">
                <img class="rounded-lg border-gray-200 border-2" src="{{asset('images/ohnocringe.jpeg')}}" alt="">
            </span>
          </div>
            ...
            <nav aria-label="Main Nav" class="flex flex-col p-2">
              ...
              <ul class="space-y-1 border-t border-gray-100 pt-4">
                ...
                <li>
                  <a
                    href=""
                    class="group relative flex justify-center rounded px-2 py-1.5 bg-blue-50 text-blue-700"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-5 w-5 opacity-75"
